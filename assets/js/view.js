var View = (function () {
    ...
    View.prototype = {
        setup: function () {
            ...
            winContainer.classList.remove('action');
        ...
        winning: function () {
            ...
            winContainer.classList.add('action');
        },
        ...
        getPos: function (pos) {
            var gridCell = $(`.grid-divider:nth-child(${pos.y+1}) .grid-box-sm:nth-child(${pos.x+1})`)[0];
            return {
